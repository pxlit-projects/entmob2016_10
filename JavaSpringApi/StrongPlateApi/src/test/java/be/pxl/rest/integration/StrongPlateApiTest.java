...
public class StrongPlateApiTest {
    ...
    @Test
    public void bosCanEditUsersTest() throws Exception {
        MvcResult mockMvcResult = mockMvc.perform(put("/User/editUser/2")
        ...
        assertEquals(mockMvcResult.getResponse().getContentAsString(), "User bewerkt");
    ...
    public void bosCanAddUserTest() throws Exception {
        ...
        MvcResult mockMvcResult = mockMvc.perform(post("/User/addUser")
                .content(userAsJson)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.parseMediaType("application/json;charset=UTF-8"))
                .with(httpBasic("1", "secret")))
                ...
                .andReturn();
        assertEquals(mockMvcResult.getResponse().getContentAsString(), "User toegevoegd aan database");
    }
    ...
    @Test
    public void getStrongPlateDataByUserIdTest() throws Exception {
        MvcResult mockMvcResult = mockMvc.perform(get("/Plate/getDataByUserId/2")
                .with(httpBasic("2", "secret"))
                .accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
                .andExpect(status().isOk())/*.andDo(print())*/.andReturn();
        replyPlatesUsersId = mockMvcResult.getResponse().getContentAsString();
